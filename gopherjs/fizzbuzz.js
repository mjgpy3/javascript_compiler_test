...
$packages["strconv"] = (function() {
	var $pkg = {}, math = $packages["math"], errors = $packages["errors"], utf8 = $packages["unicode/utf8"], shifts, FormatInt, Itoa, formatBits;
...
$packages["main"] = (function() {
	var $pkg = {}, js = $packages["github.com/gopherjs/gopherjs/js"], strconv = $packages["strconv"], fizzBuzz, main;
	fizzBuzz = function(number) {
		var result, _r, _r$1;
		result = "";
		if ((_r = number % 3, _r === _r ? _r : $throwRuntimeError("integer divide by zero")) === 0) {
			result = result + ("Fizz");
		}
		if ((_r$1 = number % 5, _r$1 === _r$1 ? _r$1 : $throwRuntimeError("integer divide by zero")) === 0) {
			result = result + ("Buzz");
		}
		if (result === "") {
	...
	main = function() {
		...
		$global.document.write($externalize(result, $String));
	};
	$pkg.$run = function($b) {
